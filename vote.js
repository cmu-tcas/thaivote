        ...
        if (user) {
            document.getElementById("user-fname-display").textContent = user.fname;
            document.getElementById("username-display").textContent = user.username;
        } else {
            alert("User not logged in.");
            window.location.href = "index.html"; // ส่งกลับไปหน้า Login
        }
        ...
        function sendVote() {
            ...
            const ptpVote = document.getElementById("ptp").checked ? "Yes" : "No";
            const ffpVote = document.getElementById("ffp").checked ? "Yes" : "No";
            ...
            // บันทึกข้อมูลโหวตลง localStorage (หรือนำไปใช้งานอื่น)
            localStorage.setItem("voteSubmission", JSON.stringify(voteData));
